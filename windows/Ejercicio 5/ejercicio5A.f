...
!       Encontrar la o las raices de la ecuacion f(x)=exp(x)-x-2
!       utilizando los métodos del problema 3. Graficar la función.
!       Resolver de dos maneras, primero despejando x del primer
!       termino y luego del segundo., respectivamente

 !     funcion despejada (exp(x)-2)-x
...
!      defino variables
 ...
 !      primer saludo en la pantalla
       ...
       print *,'solucionar es x=(exp(x)-2), antes de continuar'
